...
//        employeeQuery.setHint("org.hibernate.cacheable", true);
...
//	        log.info("BBBBBBBBBBBBBBBBBBBBBBBBBBPerson displaying : " + personList.stream().findFirst().get().getEmail());
        ...
        jobQuery.setHint("org.hibernate.cacheable", true);
        ...
        TestTransaction.end();
        //il faut etre dans une transaction differentes pour jouer avec le cache de nvo 2
        TestTransaction.start();
        
        
        TypedQuery<Job> jobQuery2 = entityManager.createQuery("FROM Job", Job.class);
        jobQuery2.setHint("org.hibernate.cacheable", true);
        List<Job> jobList2 = jobQuery2.getResultList();
        log.info("EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE displaying : " + jobList2.stream().findFirst().get().getJobTitle());
        TestTransaction.end();
